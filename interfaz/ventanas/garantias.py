...
from modulos.garantias_LOGICA import ModuloGarantias
...
class VentanaGarantias(QWidget):
    ...
    def inicializar_ui(self):
        ...
        titulo = Etiqueta("✅ Gestión de Garantías", "titulo")
    ...
    def actualizar_estadisticas(self):
        ...
        # Obtener stats (sin filtros de fecha por ahora)
        stats = ModuloGarantias.obtener_estadisticas_garantias()
        ...
        self.layout_stats.addWidget(self.crear_tarjeta("Por Vencer (≤7 días)", str(stats.get('proximas_a_vencer', 0)), "#ffc107"))
    ...
    def cargar_garantias(self):
        """Carga las garantías"""
        try:
            # Por ahora sin filtros complejos - solo traer todas
