...
from modulos.repuestos_LOGICA import ModuloRepuestos
...
class VentanaRepuestos(QWidget):
    ...
    def inicializar_ui(self):
        ...
        titulo = Etiqueta("📦 Gestión de Repuestos", "titulo")
    ...
    def crear_tarjetas_estadisticas(self):
        ...
        # Total items
        t1 = self.crear_tarjeta("Items Diferentes", str(stats.get('total_items', 0)), "#3498db")
        layout.addWidget(t1)
        
        # Total unidades
        t2 = self.crear_tarjeta("Total Unidades", str(stats.get('total_unidades', 0)), "#17a2b8")
        layout.addWidget(t2)
        
        # Stock bajo
        t3 = self.crear_tarjeta("Stock Bajo", str(stats.get('stock_bajo', 0)), "#ffc107")
        layout.addWidget(t3)
        
        # Sin stock
        t4 = self.crear_tarjeta("Sin Stock", str(stats.get('sin_stock', 0)), "#dc3545")
        layout.addWidget(t4)
        
        # Valor total
        t5 = self.crear_tarjeta("Valor Total", formatear_dinero(stats.get('valor_total', 0)), "#28a745")
        layout.addWidget(t5)
