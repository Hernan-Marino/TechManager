...
from modulos.configuracion_LOGICA import ModuloConfiguracion
...
class VentanaConfiguracion(QWidget):
    ...
    def inicializar_ui(self):
        ...
        titulo = Etiqueta("⚙ Configuración del Sistema", "titulo")
        ...
        layout_barra.addWidget(boton_volver)
    ...
    def crear_tab_dias(self):
        ...
        self.spin_estancado.setValue(getattr(config, 'dias_alerta_equipo_estancado', 15))
        ...
        self.spin_abandonado.setValue(getattr(config, 'dias_alerta_equipo_abandonado', 30))
        ...
        self.spin_vencimiento.setValue(getattr(config, 'dias_vencimiento_presupuesto', 30))
        ...
        self.spin_garantia.setValue(getattr(config, 'dias_garantia_reparacion', 90))
    ...
    def crear_tab_porcentajes(self):
        ...
        self.campo_recargo.setText(str(getattr(config, 'porcentaje_recargo_transferencia', 0)))
        ...
        self.campo_anticipo.setText(str(getattr(config, 'porcentaje_minimo_anticipo', 0)))
        ...
        self.spin_stock.setValue(getattr(config, 'cantidad_minima_stock_repuestos', 5))
    ...
    def crear_tab_textos(self):
        ...
        self.campo_texto_remito.setPlainText(getattr(config, 'texto_pie_remito', ''))
        ...
        self.campo_texto_presupuesto.setPlainText(getattr(config, 'texto_pie_presupuesto', ''))
        ...
        self.campo_texto_garantia.setPlainText(getattr(config, 'texto_garantia', ''))
    ...
    def crear_tab_backups(self):
        ...
        self.spin_backup_intervalo.setValue(getattr(config, 'backup_dias_intervalo', 7))
        ...
        self.spin_backup_retencion.setValue(getattr(config, 'backup_dias_retencion', 30))
