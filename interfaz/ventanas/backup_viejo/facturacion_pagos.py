...
class TabFacturas(QWidget):
    ...
    def actualizar_estadisticas(self):
        ...
        self.layout_stats.addWidget(self.crear_tarjeta("Monto Total", formatear_dinero(stats['monto_total']), "#6c757d"))
        self.layout_stats.addWidget(self.crear_tarjeta("Cobrado", formatear_dinero(stats['monto_cobrado']), "#28a745"))
        self.layout_stats.addWidget(self.crear_tarjeta("Pendiente", formatear_dinero(stats['monto_pendiente']), "#dc3545"))
...
class TabPagos(QWidget):
    ...
    def actualizar_estadisticas(self):
        ...
        # Tarjetas
        self.layout_stats.addWidget(self.crear_tarjeta("Total Pagos", str(stats['total_pagos']), "#3498db"))
        self.layout_stats.addWidget(self.crear_tarjeta("Monto Total", formatear_dinero(stats['monto_total']), "#28a745"))
