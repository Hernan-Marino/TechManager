...
from modulos.backups import ModuloBackups
...
class VentanaBackups(QWidget):
    ...
    def inicializar_ui(self):
        ...
        # Info
        label_info = QLabel("Copias de seguridad automáticas y manuales de la base de datos")
        label_info.setStyleSheet("color: #6c757d; font-style: italic;")
        layout_titulo.addWidget(label_info)
        
        # Botón crear backup
        boton_nuevo = Boton("➕ Crear Backup Manual", "exito")
        boton_nuevo.clicked.connect(self.crear_backup_manual)
        layout_titulo.addWidget(boton_nuevo)
    ...
    def actualizar_estadisticas(self):
        ...
        # Crear tarjetas
        self.layout_stats.addWidget(self.crear_tarjeta("Total Backups", str(stats['total_backups']), "#3498db"))
        ...
        # Tamaño total
        tamanio_mb = stats['tamanio_total_mb']
        if tamanio_mb > 1024:
    ...
    def cargar_backups(self):
        ...
        try:
            ...
            solo_manuales = self.check_solo_manuales.isChecked()
    ...
    def limpiar_antiguos(self):
        ...
        confirmacion = Mensaje.confirmacion(
            "Limpiar Backups Antiguos",
            f"Esta acción eliminará todos los backups AUTOMÁTICOS más antiguos que {config.backup_dias_retencion} días.\n\n" +
