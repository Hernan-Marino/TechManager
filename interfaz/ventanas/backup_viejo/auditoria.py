...
from modulos.auditoria import ModuloAuditoria
...
class VentanaAuditoria(QWidget):
    ...
    def inicializar_ui(self):
        ...
        # Info
        label_info = QLabel("Registro completo de todas las acciones realizadas en el sistema")
    ...
    def actualizar_estadisticas(self):
        ...
        # Crear tarjetas
        self.layout_stats.addWidget(self.crear_tarjeta("Total Registros", str(stats['total_registros']), "#3498db"))
        ...
        self.layout_stats.addWidget(self.crear_tarjeta("Usuarios Activos", str(stats['usuarios_activos']), "#ffc107"))
        self.layout_stats.addWidget(self.crear_tarjeta("Módulos Usados", str(stats['modulos_usados']), "#6c757d"))
