...
class VentanaOrdenes(QWidget):
    ...
    def crear_tarjetas_estadisticas(self):
        ...
        # Total
        t1 = self.crear_tarjeta("Total", str(stats['total']), "#3498db")
        layout.addWidget(t1)
        
        # En curso
        t2 = self.crear_tarjeta("En Curso", str(stats['en_curso']), "#ffc107")
        layout.addWidget(t2)
        
        # Finalizadas exitosas
        t3 = self.crear_tarjeta("Exitosas", str(stats['exitosas']), "#28a745")
        layout.addWidget(t3)
        
        # Sin reparación
        t4 = self.crear_tarjeta("Sin Reparación", str(stats['sin_reparacion']), "#dc3545")
        layout.addWidget(t4)
